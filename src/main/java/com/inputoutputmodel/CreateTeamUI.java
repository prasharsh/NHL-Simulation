    ...
    public void displayFreeAgents(ArrayList<IPlayer> freeAgents, int skaterCount, int goalieCount) {
        ...
        for (int i = 0; i < freeAgents.size(); i++) {
            ...
            System.out.printf("%-10d %-20s %-10s %-10d %-10s %-10s %-10s %-10s\n",
                    (i + 1),
                    currentFreeAgent.getPlayerName(),
                    currentFreeAgent.getPlayerPosition(),
                    currentFreeAgent.getPlayerAgeYear(),
                    currentFreeAgent.getPlayerSkating(),
                    currentFreeAgent.getPlayerShooting(),
                    currentFreeAgent.getPlayerChecking(),
    ...
    public void displayPlayers(ArrayList<IPlayer> players) {
        ...
        for (int i = 0; i < players.size(); i++) {
            ...
            System.out.printf("%-10d %-20s %-10s %-10d %-10s %-10s %-10s %-10s\n",
                    ...
                    currentPlayer.getPlayerAgeYear(),
