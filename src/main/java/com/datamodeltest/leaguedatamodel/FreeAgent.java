...
public class FreeAgent implements IPlayer {
    ...
    public double getPlayerStrength() {
        ...
        if (position == FreeAgent.Position.FORWARD) {
            freeAgentStrength = this.getPlayerSkating() + this.getPlayerShooting()
                    + (this.getPlayerChecking() / 2.0);
        } else if (position == FreeAgent.Position.DEFENSE) {
            freeAgentStrength = this.getPlayerSkating() + this.getPlayerChecking()
                    + (this.getPlayerShooting() / 2.0);
