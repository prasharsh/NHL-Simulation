...
public class AgingState implements IState {
	...
	public IState doTask() {
		...
		if(currentDate.compareTo(endOfSeason) == 0) {
			...
			logger.info("The stanley cup winner for season " + league.getSeason() + " is " + league.getTeamStandings().get(0).getTeam().getTeamName());
			displayRoaster.displayMessageToUser("The stanley cup winner for season " + league.getSeason() + " is " + league.getTeamStandings().get(0).getTeam().getTeamName());
