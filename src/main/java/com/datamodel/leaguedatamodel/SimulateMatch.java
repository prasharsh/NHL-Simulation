...
public class SimulateMatch implements ISimulateMatch {
    ...
    @Override
    public boolean simulateMatchResult(ITeam team, double teamStrength, ITeam opponentTeam, double opponentTeamStrength, IGame game) {
        ...
        if (teamStrength > opponentTeamStrength) {
