...
public class LeagueTest {
    ...
    public void addConferenceWithNullConferenceNameTest()
    {
        ...
        Assert.assertFalse("Conference with null conference name cannot not be inserted", league.addConference(conference));
    }
    ...
    public void addConferenceWithEmptyConferenceNameTest()
    {
        ...
        Assert.assertFalse("Conference with empty conference name cannot not be inserted", league.addConference(conference));
    }
    ...
    public void addFreeAgentWithNullFreeAgentNameTest()
    {
        ...
        Assert.assertFalse("Free Agent with null freeAgent name cannot not be inserted", league.addFreeAgent(freeAgent));
    }
    ...
    public void addFreeAgentWithEmptyFreeAgentNameTest()
    {
        ...
        Assert.assertFalse("Free Agent with empty freeAgent name cannot not be inserted", league.addFreeAgent(freeAgent));
    }
    ...
    public void addFreeAgentWithExistingFreeAgentNameTest()
    {
        ...
        Assert.assertFalse("New Free Agent with same FreeAgent name cannot not be inserted", league.addFreeAgent(freeAgent2));
    }
